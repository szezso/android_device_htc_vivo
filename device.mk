...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/idc/cy8c-touchscreen.idc:system/usr/idc/cy8c-touchscreen.idc \
    $(COMMON_PATH)/idc/elan-touchscreen.idc:system/usr/idc/elan-touchscreen.idc \
    $(COMMON_PATH)/idc/vivo-keypad.idc:system/usr/idc/vivo-keypad.idc

# Keychars
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/keychars/atmel-touchscreen.kcm:system/usr/keychars/atmel-touchscreen.kcm \
    $(COMMON_PATH)/keychars/cy8c-touchscreen.kcm:system/usr/keychars/cy8c-touchscreen.kcm \
    $(COMMON_PATH)/keychars/elan-touchscreen.kcm:system/usr/keychars/elan-touchscreen.kcm
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/keylayout/vivo-keypad.kl:system/usr/keylayout/vivo-keypad.kl \
    $(COMMON_PATH)/keylayout/atmel-touchscreen.kl:system/usr/keylayout/atmel-touchscreen.kl \
    $(COMMON_PATH)/keylayout/cy8c-touchscreen.kl:system/usr/keylayout/cy8c-touchscreen.kl \
    $(COMMON_PATH)/keylayout/elan-touchscreen.kl:system/usr/keylayout/elan-touchscreen.kl
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/dsp/AdieHWCodec_NEL.csv:system/etc/AdieHWCodec_NEL.csv \
    ...
    $(COMMON_PATH)/dsp/AIC3254_REG_DualMic_NEL.csv:system/etc/AIC3254_REG_DualMic_NEL.csv \
    $(COMMON_PATH)/dsp/AIC3254_REG_DualMicXB.csv:system/etc/AIC3254_REG_DualMicXB.csv \
    $(COMMON_PATH)/dsp/TPA2051_CFG.csv:system/etc/TPA2051_CFG.csv \
    $(COMMON_PATH)/dsp/TPA2051_CFG_NEL.csv:system/etc/TPA2051_CFG_NEL.csv \
    $(COMMON_PATH)/dsp/CodecDSPID_BCLK.txt:system/etc/CodecDSPID_BCLK.txt \
    ...
    $(COMMON_PATH)/dsp/soundimage/Sound_Original_BCLK.txt:system/etc/soundimage/Sound_Original_BCLK.txt \
    $(COMMON_PATH)/dsp/soundimage/Sound_Original_Recording_BCLK.txt:system/etc/soundimage/Sound_Original_Recording_BCLK.txt \
    $(COMMON_PATH)/dsp/soundimage/Sound_Original_Recording.txt:system/etc/soundimage/Sound_Original_Recording.txt \
    $(COMMON_PATH)/dsp/soundimage/Sound_Original_SPK_BCLK.txt:system/etc/soundimage/Sound_Original_SPK_BCLK.txt \
    ...
    $(COMMON_PATH)/dsp/soundimage/Sound_Phone_Original_HP_BCLK.txt:system/etc/soundimage/Sound_Phone_Original_HP_BCLK.txt \
    $(COMMON_PATH)/dsp/soundimage/Sound_Phone_Original_HP.txt:system/etc/soundimage/Sound_Phone_Original_HP.txt \
    $(COMMON_PATH)/dsp/soundimage/Sound_Phone_Original_REC_BCLK.txt:system/etc/soundimage/Sound_Phone_Original_REC_BCLK.txt \
    ...
    $(COMMON_PATH)/dsp/soundimage/Sound_Phone_Original_SPK_BCLK.txt:system/etc/soundimage/Sound_Phone_Original_SPK_BCLK.txt \
...
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/prebuilt/rotate_lights.sh:/system/etc/rotate_lights.sh
